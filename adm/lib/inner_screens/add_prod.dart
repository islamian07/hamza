...
class _UploadProductFormState extends State<UploadProductForm> {
  ...
  late final TextEditingController _titleController,_descController, _priceController;
  int _groupValue = 1;
  bool isPiece = false;
  File? _pickedImage;
    ...
    if (isValid) {
      ...
      if(_pickedImage == null){
        GlobalMethods.errorDialog(
            subtitle: 'Please pickup an image', context: context);
        return;
      }
